...
$MOSES_SCRIPTS/scripts/training/clean-corpus-n.perl $data_dir/ted-corpus.tok $src $trg $data_dir/ted-corpus.tok.clean 1 80

# train truecaser
$MOSES_SCRIPTS/scripts/recaser/train-truecaser.perl -corpus $data_dir/ted-corpus.tok.clean.$src -model $model_dir/truecase-model.$src
$MOSES_SCRIPTS/scripts/recaser/train-truecaser.perl -corpus $data_dir/ted-corpus.tok.clean.$trg -model $model_dir/truecase-model.$trg
...
# train BPE
subword-nmt learn-joint-bpe-and-vocab -i $data_dir/ted-corpus.tc.$src $data_dir/ted-corpus.tc.$trg --write-vocabulary $data_dir/vocab.$src $data_dir/vocab.$trg -s $bpe_operations -o $model_dir/$src$trg.bpe
...
$nematus_home/data/build_dictionary.py $data_dir/ted-corpus.bpe.$src $data_dir/ted-corpus.bpe.$trg
